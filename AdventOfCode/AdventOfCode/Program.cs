...
namespace AdventOfCode
{
    class Program
    {
        ...
        {
            int count = 0;
            List<int> lines = System.IO.File.ReadAllLines("/Users/jackmedley-hill/Downloads/input.txt").Select(x => int.Parse(x)).ToList();
        ...
        static int Result2Part1()
        {
            int x = 0;
            int y = 0;
            List<string> lines = System.IO.File.ReadAllLines("/Users/jackmedley-hill/Downloads/input2.txt").ToList();
